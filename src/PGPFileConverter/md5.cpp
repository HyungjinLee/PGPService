 ...
 */
static void MD5Transform(UINT4 state[], unsigned char block[64])
{
 ...
 */
unsigned char* MD5::MDString(char* string)
{
	unsigned int len = strlen(string);

	MDInit();
	MDUpdate((unsigned char*) string, len);
